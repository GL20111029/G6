((typeof globalThis !== 'undefined' ? globalThis : self)["makoChunk_@antv/g6-site"] = (typeof globalThis !== 'undefined' ? globalThis : self)["makoChunk_@antv/g6-site"] || []).push([
        ['docs/manual/layout/Fishbone.zh.md?type=text'],
{ "docs/manual/layout/Fishbone.zh.md?type=text": function (module, exports, __mako_require__){
"use strict";
...
__mako_require__("docs/manual/layout/Fishbone.zh.md?watch=parent");
var prevRefreshReg;
var prevRefreshSig;
...
const texts = [
    {
        "value": "鱼骨布局是一种专门用于表示层次结构数据的图形布局方式。它通过模拟鱼骨的形状，将数据节点按照层次结构排列，使得数据的层次关系更加清晰直观。鱼骨布局特别适用于需要展示因果关系、层次结构或分类信息的数据集。",
        "paraId": 0,
        "tocIndex": 0
    },
    {
        "value": "需要展示层次结构数据，如组织结构、分类体系",
        "paraId": 1,
        "tocIndex": 1
    },
    {
        "value": "需要展示问题分析过程，如故障分析、质量分析",
        "paraId": 1,
        "tocIndex": 1
    },
    {
        "value": "需要展示决策过程，如决策树、影响因素分析",
        "paraId": 1,
        "tocIndex": 1
    },
    {
    ...
    {
        "value": "使用前布局，在初始化元素前计算布局，不适用于流水线布局",
        "paraId": 4,
        "tocIndex": 4
    },
    {
...
//# sourceMappingURL=docs_manual_layout_Fishbone_zh_md_q_hK4X-async.js.map