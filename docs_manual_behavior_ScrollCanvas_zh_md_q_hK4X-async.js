((typeof globalThis !== 'undefined' ? globalThis : self)["makoChunk_@antv/g6-site"] = (typeof globalThis !== 'undefined' ? globalThis : self)["makoChunk_@antv/g6-site"] || []).push([
        ['docs/manual/behavior/ScrollCanvas.zh.md?type=text'],
{ "docs/manual/behavior/ScrollCanvas.zh.md?type=text": function (module, exports, __mako_require__){
"use strict";
...
__mako_require__("docs/manual/behavior/ScrollCanvas.zh.md?watch=parent");
var prevRefreshReg;
var prevRefreshSig;
...
const texts = [
    {
        "value": "ScrollCanvas 是 G6 中用于实现画布滚动功能的内置交互，支持通过鼠标滚轮或键盘方向键平移画布。这种交互方式对于浏览较大的图表特别有用，能让用户在不改变缩放比例的情况下探索图表的不同区域。",
        "paraId": 0,
        "tocIndex": 0
    },
    {
    ...
    {
        "value": "浏览超出可视区域的大型图表内容",
        "paraId": 2,
        "tocIndex": 1
    },
    {
        "value": "在保持当前缩放比例的情况下探索图的不同部分",
        "paraId": 2,
        "tocIndex": 1
    },
    {
        "value": "精确调整查看位置，尤其是在一维方向上需要精确滚动时",
        "paraId": 2,
        "tocIndex": 1
    },
    {
    ...
    {
        "value": "这在特定的可视化场景下很有用，例如在时间轴图表中可能只需要水平滚动。",
        "paraId": 17,
        "tocIndex": 5
    },
    {
    ...
    {
        "value": "range: 2; // 在任何方向上都可以滚动2个视口的距离\nrange: [1, 2, 1, 2]; // 上下方向可滚动1个视口，左右方向可滚动2个视口\n",
        "paraId": 21,
        "tocIndex": 6
    },
    {
        "value": "每个方向的取值范围是 [0, Infinity]，0表示不能滚动，Infinity表示无限滚动。",
        "paraId": 22,
        "tocIndex": 6
    },
    {
    ...
    {
        "value": " 用于缩放画布，改变视图的缩放比例",
        "paraId": 31,
        "tocIndex": 14
    },
    {
        "value": "两者常结合使用，提供完整的画布导航功能：",
        "paraId": 32,
        "tocIndex": 14
    },
    {
...
//# sourceMappingURL=docs_manual_behavior_ScrollCanvas_zh_md_q_hK4X-async.js.map