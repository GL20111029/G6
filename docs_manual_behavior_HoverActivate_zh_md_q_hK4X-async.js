((typeof globalThis !== 'undefined' ? globalThis : self)["makoChunk_@antv/g6-site"] = (typeof globalThis !== 'undefined' ? globalThis : self)["makoChunk_@antv/g6-site"] || []).push([
        ['docs/manual/behavior/HoverActivate.zh.md?type=text'],
{ "docs/manual/behavior/HoverActivate.zh.md?type=text": function (module, exports, __mako_require__){
"use strict";
...
__mako_require__("docs/manual/behavior/HoverActivate.zh.md?watch=parent");
var prevRefreshReg;
var prevRefreshSig;
...
const texts = [
    {
        "value": "HoverActivate 是 G6 中用于实现元素悬停激活效果的内置交互，当鼠标悬停在节点或边上时，会自动触发高亮、显示等视觉反馈。该交互是图可视化中增强数据探索的重要手段，有助于用户快速聚焦目标元素并获取相关信息。",
        "paraId": 0,
        "tocIndex": 0
    },
    {
    ...
    {
        "value": "在复杂关系图中快速定位关注元素",
        "paraId": 2,
        "tocIndex": 1
    },
    {
        "value": "通过悬停信息展示节点额外信息",
        "paraId": 2,
        "tocIndex": 1
    },
    {
        "value": "分析节点间关联关系时，通过激活边凸显连接路径",
        "paraId": 2,
        "tocIndex": 1
    },
    {
    ...
    {
        "value": " 用于控制是否开启元素的悬浮高亮，可接收一个函数来动态控制",
        "paraId": 12,
        "tocIndex": 5
    },
    {
...
//# sourceMappingURL=docs_manual_behavior_HoverActivate_zh_md_q_hK4X-async.js.map