((typeof globalThis !== 'undefined' ? globalThis : self)["makoChunk_@antv/g6-site"] = (typeof globalThis !== 'undefined' ? globalThis : self)["makoChunk_@antv/g6-site"] || []).push([
        ['docs/manual/element/node/BaseNode.zh.md?type=text'],
{ "docs/manual/element/node/BaseNode.zh.md?type=text": function (module, exports, __mako_require__){
"use strict";
...
__mako_require__("docs/manual/element/node/BaseNode.zh.md?watch=parent");
var prevRefreshReg;
var prevRefreshSig;
...
const texts = [
    ...
    {
        "value": "指定节点类型，内置节点类型名称或自定义节点的名称。默认为 ",
        "paraId": 8,
        "tocIndex": 1
    },
    {
    ...
    {
        "value": " 属性同样支持动态配置，可以根据节点数据动态选择节点类型：",
        "paraId": 10,
        "tocIndex": 1
    },
    {
    ...
    {
        "value": "：以下所有样式属性都支持动态配置，即可以传入函数来根据节点数据动态计算属性值：",
        "paraId": 26,
        "tocIndex": 2
    },
    {
    ...
    {
        "value": " ：节点的主图形，表示节点的主要形状，例如矩形、圆形等；",
        "paraId": 30,
        "tocIndex": 2
    },
    {
    ...
    {
        "value": " ：图标图形，通常用于展示节点的图标，可以是图片或者文本图标；",
        "paraId": 30,
        "tocIndex": 2
    },
    {
    ...
    {
        "value": "主图形是节点的核心部分，定义了节点的基本形状和外观。以下是常见的配置场景：",
        "paraId": 32,
        "tocIndex": 3
    },
    {
    ...
    {
        "value": "transform 属性允许你旋转、缩放、倾斜或平移给定节点",
        "paraId": 40,
        "tocIndex": 6
    },
    {
    ...
    {
        "value": "节点大小，快捷设置节点宽高，支持三种配置方式：",
        "paraId": 44,
        "tocIndex": 7
    },
    {
        "value": "number：表示节点宽高相同为指定值",
        "paraId": 45,
        "tocIndex": 7
    },
    {
        "value": "[number, number]：表示节点宽高分别为数组元素依次表示节点的宽度、高度",
        "paraId": 45,
        "tocIndex": 7
    },
    {
        "value": "[number, number, number]：表示节点宽高分别为数组元素依次表示节点的宽度、高度以及深度",
        "paraId": 45,
        "tocIndex": 7
    },
    {
    ...
    {
        "value": "标签用于显示节点的文本信息，支持多种样式配置和布局方式。以下是常见的使用场景：",
        "paraId": 60,
        "tocIndex": 10
    },
    {
    ...
    {
        "value": "节点标签是否开启自动折行。开启 labelWordWrap 后，超出 labelMaxWidth 的部分自动换行",
        "paraId": 68,
        "tocIndex": 13
    },
    {
    ...
    {
        "value": "string: 表示以相对于节点宽度的百分比形式定义最大宽度。例如 ",
        "paraId": 74,
        "tocIndex": 15
    },
    {
    ...
    {
        "value": "光晕是围绕节点主图形显示的效果，通常用于高亮显示或表示节点的特殊状态。",
        "paraId": 80,
        "tocIndex": 17
    },
    {
    ...
    {
        "value": "此属性用于设置节点周围光晕的颜色，帮助突出显示节点",
        "paraId": 84,
        "tocIndex": 18
    },
    {
    ...
    {
        "value": "节点图标支持三种常见的使用方式：文字图标、图片图标和 IconFont 图标。下面分别展示这三种方式的配置：",
        "paraId": 87,
        "tocIndex": 19
    },
    {
        "value": "直接使用文字作为图标，适合简单的标识：",
        "paraId": 88,
        "tocIndex": 20
    },
    {
    ...
    {
        "value": "使用 IconFont 字体图标，需要先引入相应的字体文件：",
        "paraId": 92,
        "tocIndex": 22
    },
    {
    ...
    {
        "value": "徽标是节点上显示的小标记，通常用于展示状态、数量或其他辅助信息。支持多个徽标同时显示，并可自定义位置。",
        "paraId": 96,
        "tocIndex": 23
    },
    {
    ...
    {
        "value": "节点徽标背景填充色。若不指定，优先考虑 badgePalette 按顺序分配",
        "paraId": 106,
        "tocIndex": 27
    },
    {
    ...
    {
        "value": "节点徽标相对于节点主图形的位置。若不指定，默认从右上角顺时针依次排放",
        "paraId": 106,
        "tocIndex": 27
    },
    {
    ...
    {
        "value": "连接桩是节点上的连接点，用于连接边。支持在节点的不同位置添加多个连接桩，并可自定义样式。",
        "paraId": 108,
        "tocIndex": 28
    },
    {
        "value": "为节点添加四个基本方向的连接桩：",
        "paraId": 109,
        "tocIndex": 29
    },
    {
    ...
    {
        "value": " - 如果设置为 undefined，则连接桩被视为一个点，不在画布上显示但存在，边会优先连接到最近的连接桩 ",
        "paraId": 118,
        "tocIndex": 32
    },
    {
        "value": " - 如果设置为数字，则连接桩被视为一个圆，圆的半径由此处指定",
        "paraId": 118,
        "tocIndex": 32
    },
    {
    ...
    {
        "value": "边是否连接到节点连接桩的中心 ",
        "paraId": 118,
        "tocIndex": 32
    },
    {
        "value": " - 若为 true，则边连接到节点连接桩的中心 ",
        "paraId": 118,
        "tocIndex": 32
    },
    {
        "value": " - 若为 false，则边连接到节点连接桩的边缘",
        "paraId": 118,
        "tocIndex": 32
    },
    {
    ...
    {
        "value": "在一些交互行为中，比如点击选中一个节点或鼠标悬停激活一个边，仅仅是在该元素做了某些状态的标识。为了将这些状态反应到终端用户所见的视觉空间中，我们需要为不同的状态设置不同的图元素样式，以响应该图元素状态的变化。",
        "paraId": 120,
        "tocIndex": 33
    },
    {
    ...
    {
        "value": "阶段动画是指节点在进入画布、更新、离开画布时的动画效果。目前支持的阶段包括：",
        "paraId": 132,
        "tocIndex": 34
    },
    {
    ...
    {
        "value": "定义节点的色板，即预定义节点颜色池，并根据规则进行分配，将颜色映射到 ",
        "paraId": 141,
        "tocIndex": 35
    },
    {
...
//# sourceMappingURL=docs_manual_element_node_BaseNode_zh_md_q_hK4X-async.js.map