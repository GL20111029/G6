((typeof globalThis !== 'undefined' ? globalThis : self)["makoChunk_@antv/g6-site"] = (typeof globalThis !== 'undefined' ? globalThis : self)["makoChunk_@antv/g6-site"] || []).push([
        ['.dumi/tmp/theme-antv/ContextWrapper.tsx'],
{ ".dumi/tmp/theme-antv/ContextWrapper.tsx": function (module, exports, __mako_require__){
// @ts-nocheck
...
__mako_require__.d(exports, "default", {
    enumerable: true,
    get: function() {
        return ThemeAntVContextWrapper;
    }
});
...
var _context = __mako_require__("../../node_modules/.pnpm/@antv+dumi-theme-antv@0.8.0-beta.12_@algolia+client-search@5.42.0_@babel+core@7.28.5_@e_ea539378146e0670f62daf9de481569e/node_modules/@antv/dumi-theme-antv/dist/context.js");
var prevRefreshReg;
var prevRefreshSig;
...
var _s = $RefreshSig$();
function ThemeAntVContextWrapper() {
    _s();
    const outlet = (0, _dumi.useOutlet)();
    return /*#__PURE__*/ (0, _jsxdevruntime.jsxDEV)(_context.ThemeAntVContext.Provider, {
        value: {
            meta: {
                "exampleTopics": [
                    {
                                ...
                                "demos": [
                                    {
                                        ...
                                        "source": "import { Graph, iconfont } from '@antv/g6';\n\nconst style = document.createElement('style');\nstyle.innerHTML = `@import url('${iconfont.css}');`;\ndocument.head.appendChild(style);\n\nconst data = {\n  nodes: [\n    { id: 'default' },\n    { id: 'halo' },\n    { id: 'badges' },\n    { id: 'ports' },\n    {\n      id: 'active',\n      states: ['active'],\n    },\n    {\n      id: 'selected',\n      states: ['selected'],\n    },\n    {\n      id: 'highlight',\n      states: ['highlight'],\n    },\n    {\n      id: 'inactive',\n      states: ['inactive'],\n    },\n    {\n      id: 'disabled',\n      states: ['disabled'],\n    },\n  ],\n};\n\nconst graph = new Graph({\n  container: 'container',\n  data,\n  node: {\n    type: 'circle',\n    style: {\n      size: 40,\n      labelText: (d) => d.id,\n      iconFontFamily: 'iconfont',\n      iconText: '\\ue602',\n      halo: (d) => (d.id === 'halo' ? true : false),\n      badges: (d) =>\n        d.id === 'badges'\n          ? [\n              {\n                text: 'A',\n                placement: 'right-top',\n              },\n              {\n                text: 'Important',\n                placement: 'right',\n              },\n              {\n                text: 'Notice',\n                placement: 'right-bottom',\n              },\n            ]\n          : [],\n      badgeFontSize: 8,\n      badgePadding: [1, 4],\n      portR: 3,\n      ports: (d) =>\n        d.id === 'ports'\n          ? [{ placement: 'left' }, { placement: 'right' }, { placement: 'top' }, { placement: 'bottom' }]\n          : [],\n    },\n  },\n  layout: {\n    type: 'grid',\n  },\n});\n\ngraph.render();\n",
                                        "title": {
                                            "zh": "圆形",
                                            "en": "Circle"
                                        },
                        ...
                        "examples": [
                            {
                                ...
                                "icon": "",
                                "id": "process-parallel-edges",
                                "title": {
                                    "en": "Process Parallel Edges",
                                    "zh": "Process Parallel Edges 平行边"
                                },
                                "api": null,
                                "childrenKey": "demos",
                                "order": 0
                        ...
                        "examples": [
                            {
                                "demos": [
                                    ...
                                    },
                                    {
                                        "id": "louvain",
                                        "screenshot": "https://mdn.alipayobjects.com/huamei_qa8qxu/afts/img/A*1QHsR4wHCKwAAAAAAAAAAAAADmJ7AQ/original",
                                        "source": "import { louvain } from '@antv/algorithm';\nimport { Graph } from '@antv/g6';\n\nconst colors = [\n  '#5F95FF',\n  '#61DDAA',\n  '#65789B',\n  '#F6BD16',\n  '#7262FD',\n  '#78D3F8',\n  '#9661BC',\n  '#F6903D',\n  '#008685',\n  '#F08BB4',\n];\n\nfetch('https://gw.alipayobjects.com/os/antvdemo/assets/data/relations.json')\n  .then((res) => res.json())\n  .then((data) => {\n    const graph = new Graph({\n      container: 'container',\n      data,\n      autoFit: 'view',\n      behaviors: ['drag-canvas', 'zoom-canvas', 'drag-element'],\n      layout: {\n        type: 'force',\n        linkDistance: 50,\n        animation: false,\n      },\n    });\n    graph.render();\n\n    window.addPanel((gui) => {\n      gui.add(\n        {\n          Cluster: () => {\n            const clusteredData = louvain(data, false);\n            const result = clusteredData.clusters\n              .map((cluster, i) => {\n                const color = colors[i % colors.length];\n                const nodes = cluster.nodes.map((node) => ({\n                  id: node.id,\n                  style: {\n                    fill: color,\n                  },\n                }));\n                return nodes;\n              })\n              .flat();\n            graph.updateNodeData(result);\n            graph.draw();\n          },\n        },\n        'Cluster',\n      );\n    });\n  });\n",
                                        "title": {
                                            "zh": "LOUVAIN 自动聚类",
        ...
        fileName: ".dumi/tmp/theme-antv/ContextWrapper.tsx",
        lineNumber: 12,
        columnNumber: 5
    }, this);
}
_s(ThemeAntVContextWrapper, "dA9PpjQVk8MlVq4pr8ZEpkAmEDs=", false, function() {
    return [
        _dumi.useOutlet
    ];
});
_c = ThemeAntVContextWrapper;
var _c;
$RefreshReg$(_c, "ThemeAntVContextWrapper");
...
//# sourceMappingURL=_dumi_tmp_theme-antv_ContextWrapper_tsx-async.js.map