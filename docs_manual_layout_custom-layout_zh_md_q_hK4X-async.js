((typeof globalThis !== 'undefined' ? globalThis : self)["makoChunk_@antv/g6-site"] = (typeof globalThis !== 'undefined' ? globalThis : self)["makoChunk_@antv/g6-site"] || []).push([
        ['docs/manual/layout/custom-layout.zh.md?type=text'],
{ "docs/manual/layout/custom-layout.zh.md?type=text": function (module, exports, __mako_require__){
"use strict";
...
__mako_require__("docs/manual/layout/custom-layout.zh.md?watch=parent");
var prevRefreshReg;
var prevRefreshSig;
...
const texts = [
    ...
    {
        "value": "两种，迭代布局是指布局算法会迭代多次直到收敛，非迭代布局是指布局算法只执行一次。",
        "paraId": 0,
        "tocIndex": 0
    },
    {
        "value": "实现一个非迭代布局相对简单，只需要实现 ",
        "paraId": 1,
        "tocIndex": 2
    },
    {
    ...
    {
        "value": "在上面的代码中，我们实现了一个简单的布局算法，将节点从左上角沿对角线排列。",
        "paraId": 3,
        "tocIndex": 2
    },
    {
    ...
    {
        "value": " 方法返回的是一个 GraphData 对象，里面仅需要包含元素的基本信息（如 id、source、target）以及布局新增的属性（如 x、y、边的控制点等），不需要包含其他无用的信息。\n如果仅需要对节点进行布局，可以只返回节点信息，不需要返回边的信息。",
        "paraId": 5
    },
    {
        "value": "迭代布局的实现同样需要继承 ",
    ...
    {
        "value": "在这个例子中，我们实现了一个简单的迭代布局算法，每 200ms 将节点的 x 坐标在 50 和 150 之间切换，并按照节点顺序在 y 方向上排列。",
        "paraId": 11,
        "tocIndex": 3
    },
    {
...
//# sourceMappingURL=docs_manual_layout_custom-layout_zh_md_q_hK4X-async.js.map