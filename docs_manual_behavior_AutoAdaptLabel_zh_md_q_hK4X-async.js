((typeof globalThis !== 'undefined' ? globalThis : self)["makoChunk_@antv/g6-site"] = (typeof globalThis !== 'undefined' ? globalThis : self)["makoChunk_@antv/g6-site"] || []).push([
        ['docs/manual/behavior/AutoAdaptLabel.zh.md?type=text'],
{ "docs/manual/behavior/AutoAdaptLabel.zh.md?type=text": function (module, exports, __mako_require__){
"use strict";
...
__mako_require__("docs/manual/behavior/AutoAdaptLabel.zh.md?watch=parent");
var prevRefreshReg;
var prevRefreshSig;
...
const texts = [
    {
        "value": "标签自适应显示是一种动态标签管理策略，旨在根据当前可视范围的空间分配、节点重要性等因素，智能调整哪些标签应显示或隐藏。通过对可视区域的实时分析，确保用户在不同的交互场景下获得最相关最清晰的信息展示，同时避免视觉过载和信息冗余。",
        "paraId": 0,
        "tocIndex": 0
    },
    {
    ...
    {
        "value": "自定义排序函数，根据元素的重要性从高到低排序，重要性越高的元素其标签显示优先级越高。一般情况下 combo > node > edge",
        "paraId": 11,
        "tocIndex": 4
    },
    {
    ...
    {
        "value": "根据节点的重要性从高到低排序，重要性越高的节点其标签显示优先级越高。内置几种",
        "paraId": 11,
        "tocIndex": 4
    },
    {
    ...
    {
        "value": "根据边的重要性从高到低排序，重要性越高的边其标签显示优先级越高。默认按照数据先后进行排序。需要注意，如果设置了 ",
        "paraId": 11,
        "tocIndex": 4
    },
    {
    ...
    {
        "value": "根据群组的重要性从高到低排序，重要性越高的群组其标签显示优先级越高。默认按照数据先后进行排序。需要注意，如果设置了 ",
        "paraId": 11,
        "tocIndex": 4
    },
    {
...
//# sourceMappingURL=docs_manual_behavior_AutoAdaptLabel_zh_md_q_hK4X-async.js.map